                ...
                <div class="el-table el-table--fit el-table--border el-table--enable-row-hover el-table--enable-row-transition">
                    <table cellspacing="0" cellpadding="0" border="0">
                        ...
                        <tr>
                            ...
                            <td>
                                <el-input v-model="detail.CDesc" size="small" />
                            </td>
                        </tr>
                        <tr>
                            <td class="td-title" width="140">内容</td>
                            <td>
                                <el-input v-model="detail.Content" type="textarea" rows="28" />
                            </td>
                        </tr>
                    </table>
                </div>
...
<script>
import { fetchDetail, updateConfig } from '@/api/config'
    ...
    methods: {
        ...
        save(){
            ...
            this.$confirm('是否要保存配置吗?', '确定', {
                ...
                this.submiting = true;
                updateConfig(this.detail.Id, this.detail.DataId, this.detail.CDesc, this.detail.Content).then((res) => {
                    this.$notify({
                        title: '成功',
                        message: '配置保存成功',
                        type: 'success',
